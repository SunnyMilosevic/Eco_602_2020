...
Model 4 (fit 4) because it the lowest of the two AIC's. However, since the values differ almost insignificantly, both would be justified to select in this case.
